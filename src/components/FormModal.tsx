...
const UnpaidStudentForm = dynamic(() => import("./forms/UnpaidStudentForm"), {
	loading: () => <h1>Loading...</h1>,
});
...
// Also render your forms as a component and not a modal
const forms: {
	[key: string]: (
...
const FormModal = ({
	...
	table:
		...
		| "event"
		| "announcement";
	type: "create" | "update" | "delete" | "print" | "more";
	data?: any;
	id?: number;
}) => {
